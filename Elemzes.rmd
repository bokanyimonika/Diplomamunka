...
kar_1fo_K <- sum(EX_hetikisebb)/1098 #98174.5
kar_1fo_nagy <- sum(EX_hetinagyobb)/1098 #229073.8

#ha nagyobb a bizt. összeg, a díj is nagyobb
100000/kar_1fo_K #1.018594
250000/kar_1fo_nagy #1.091351

havidijK <- kar_1fo_K/36*1.02
havidijN <- kar_1fo_nagy/36*1.1
havidijK*1.2
havidijN*1.2
```
